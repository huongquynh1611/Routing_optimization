...
def ex2():
    ...
    # print(names_)
    # constraints 5
    names_3 = ["x"+str(i)+str(j) + str(k)     for j in range(1, 10) for k in range(1,5) for i in range(1, 10)   ]
    # print(names_3)
    names_4 = ["x"+str(i)+str(j) + str(k)  for i in range(1, 10)    for k in range(1,5)  for j in range(1, 10)  ]
    # print(names_4)
    names_5 = list()
    ...
    names_5 = np.array(names_5).reshape(36,16)
    # print((names_5))
    for i in range(0,36):
    ...
    # constraints x00k + x11 +x22k + ... + x99k = 0
    names_7 = ["x"+str(i)+str(i) + str(k)  for i in range(1, 10)    for k in range(1,5)  ]
    for i in range(0,len(names_7)):
        constraints.append([[names_7[i]],[1]])
    # constraints 4
    names_ = ["x" + '0'+ str(j) +str(k)for k in range(1,5) for j in range(1,10) ]
    names_ = np.array(names_).reshape(4,9)
    print(names_)
    for i in range(0,4):
        constraints.append([names_[i],[1]*9 ])
    # print(names_7)
    ...
    my_sense = ["E"]*13 + ["L"]*4 + ["E"] * 36 + ["E"]*4 + ["L"] *40 + ["G"] *40 + ["E"]* len(names_7) + ["E"]*len(names_) #+["L"]*360
    # print(len(my_sense))
    my_rhs = [1]*13 + [float(capity.iat[i]) for i in range(0,4)] + [0]*36 + [1]*4 + [float(end_time.iat[i]) for i in range(0,10)]*4 + [float(start_time.iat[i]) for i in range(0,10)]*4 + [0]*len(names_7) + [1]*len(names_) #+ time_travel
